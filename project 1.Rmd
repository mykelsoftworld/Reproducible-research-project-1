...
```{r}
ggplot(table_6, aes(x = date , y = Average_steps_per_interval,group = 1 )) + geom_point(color="red", size=1) + geom_line(color="blue", size=1,group = 1 ) + facet_grid(.~day_period,scales = "free",space="free") + labs(title = "Avg. Daily Steps", x = "Days", y = "Avg. Steps per day weekdays")

# ggplot(table_4, aes(x = date , y = Average_steps_per_interval,group = 1 )) + geom_point(color="red", size=1) + geom_line(color="blue", size=1,group = 1 ) + labs(title = "Avg. Daily Steps weekends", x = "Interval", y = "Avg. Steps per day")
```
